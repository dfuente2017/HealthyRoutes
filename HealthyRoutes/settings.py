"""
Django settings for HealthyRoutes project.
...
SECRET_KEY = 'rk$@ipi%kthel!g^f&!1p!%(%e(faqz2+i$rp7)uu8b*d)7*33'
...
ROOT_URLCONF = 'HealthyRoutes.urls'
...
WSGI_APPLICATION = 'HealthyRoutes.wsgi.application'
